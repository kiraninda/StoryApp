...
import com.maghfirahdinda.storyapp.database.RemoteKeys
...
class StoryRemoteMediator( private val location:Int, private val database: StoryDatabase, private val apiService: ApiService) :
    RemoteMediator<Int, StoryModel>() {
    var token:String? =null
    constructor( token:String,  location:Int,  database: StoryDatabase, apiService: ApiService):this(location, database, apiService){
    this.token = token
    }
    companion object {
